	...
	<body>
		...
		<div id="show-userRole" class="content scaffold-show" role="main">
			...
			<ol class="property-list userRole">
				...
				<g:if test="${userRoleInstance?.dateCreated}">
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="userRole.dateCreated.label" default="Date Created" /></span>
					
						<span class="property-value" aria-labelledby="dateCreated-label"><g:formatDate date="${userRoleInstance?.dateCreated}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${userRoleInstance?.lastUpdated}">
				<li class="fieldcontain">
					<span id="lastUpdated-label" class="property-label"><g:message code="userRole.lastUpdated.label" default="Last Updated" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate date="${userRoleInstance?.lastUpdated}" /></span>
